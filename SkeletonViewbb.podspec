Pod::Spec.new do |s|
  ...
  DESC
  s.homepage     = "https://github.com/bbrichard/SkeletonViewbb"
  ...
  s.swift_version = "5.0"
  s.source       = { :git => "https://github.com/bbrichard/SkeletonViewbb.git", :tag => s.version.to_s }
